...
#
# Script generated by Vivado on Mon Aug 25 22:31:34 +0700 2025
...
# script info
echo -e "tb.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tb xil_defaultlib.tb xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/Xilinx/2025.1/Vivado/data/xsim"
  fi
